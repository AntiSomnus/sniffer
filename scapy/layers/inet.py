...
from scapy.layers.l2 import ( BitEnumField,
                              BitField,
                              ByteEnumField,
                              ByteField,
                              ConditionalField,
...
class IP(Packet, IPTools):
    ...
    fields_desc = [BitField("version", 4, 4),
                ...
                #    FlagsField("flags", 0, 3, ["1 (MF=1, DF=0)", "2 (MF=0, DF=1)", "0 (MF=0, DF=0)"]),
                   BitField("frag", 0, 13),
                   ByteField("ttl", 64),
...
class TCP(Packet):
    ...
    fields_desc = [ShortEnumField("sport", 20, TCP_SERVICES),
                   ...
                   FlagsField("flags", 0x2, 8, ["FIN", "SYN", "RST", "PSH", "ACK", "URG", "ECE", "CWR"]),
